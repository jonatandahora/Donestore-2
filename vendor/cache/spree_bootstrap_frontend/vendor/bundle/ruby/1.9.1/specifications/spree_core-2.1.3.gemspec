# -*- encoding: utf-8 -*-
# stub: spree_core 2.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activemerchant>, ["= 1.42.2"])
      s.add_runtime_dependency(%q<acts_as_list>, ["= 0.2.0"])
      s.add_runtime_dependency(%q<awesome_nested_set>, ["~> 3.0.0.rc.2"])
      ...
      s.add_runtime_dependency(%q<money>, ["~> 5.1"])
      ...
      s.add_dependency(%q<activemerchant>, ["= 1.42.2"])
      s.add_dependency(%q<acts_as_list>, ["= 0.2.0"])
      s.add_dependency(%q<awesome_nested_set>, ["~> 3.0.0.rc.2"])
